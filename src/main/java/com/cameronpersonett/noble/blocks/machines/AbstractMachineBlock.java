...
public abstract class AbstractMachineBlock extends Block {
    ...
    public AbstractMachineBlock(String title) {
    ...
    public BlockState getStateForPlacement(BlockItemUseContext context) {
        ...
        if(nearest[0].equals(Direction.UP) || nearest[0].equals(Direction.DOWN)) {
            if(nearest[1].equals(Direction.UP) || nearest[1].equals(Direction.DOWN)) {
                return defaultBlockState().setValue(BlockStateProperties.FACING, nearest[2].getOpposite());
            } return defaultBlockState().setValue(BlockStateProperties.FACING, nearest[1].getOpposite());
        } return defaultBlockState().setValue(BlockStateProperties.FACING, nearest[0].getOpposite());
    }
