...
public abstract class AbstractMachineContainer extends Container {
    public final AbstractMachineTileEntity entity;

    public AbstractMachineContainer(final int windowID, final PlayerInventory inv, final AbstractMachineTileEntity entity, ContainerType type) {
        super(type, windowID);
        this.entity = entity;
    ...
    protected static AbstractMachineTileEntity getTileEntity(final PlayerInventory inv, final PacketBuffer data) {
        ...
        if(entity instanceof AbstractMachineTileEntity) {
            return (AbstractMachineTileEntity)entity;
    ...
    public int getMaxEnergy() {
        return entity.getCapability(CapabilityEnergy.ENERGY).map(IEnergyStorage::getMaxEnergyStored).orElse(0);
    }
}
